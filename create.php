		...
		<div class="container">
			<form action="actions/a_create.php" method="post">
			  ...
			  <div class="form-group">
			    ...
			    <input type="date" class="form-control" id="publishdateInput" name="publish_date">
			  </div>
			  <div class="form-group">
			    <label for="pNameInput">Publisher</label>
			    <input type="text" class="form-control" id="pNameInput" name="publisher_name">
			  </div>
			  <div class="form-group">
			    <label for="pAddressInput">Address of Publisher</label>
			    <input type="text" class="form-control" id="pAddressInput" name="publisher_address">
			  </div>
			  <div class="form-group">
			    <label for="pSize">Publisher size</label>
			    <select class="form-control" id="pSize" name="publisher_size">
			      <option>Big</option>
			  ...
			  <div class="form-group">
			    ...
			    <select class="form-control" id="mType" name="media_type">
			      <option>Book</option>
			      <option>CD</option>
			      <option>DVD</option>
			    </select>
			  ...
			  <div class="form-group">
			   ...
			   <div class="form-group">
			    ...
			    <input type="text" class="form-control" id="aFNameInput" name="author_fname">
			  </div>
			   <div class="form-group">
			    <label for="aLNameInput">Author Lastname</label>
			    <input type="text" class="form-control" id="aLNameInput" name="author_lname">
			  </div>
