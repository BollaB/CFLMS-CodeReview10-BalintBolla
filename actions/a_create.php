	  ...
	  <div class="container">
		...
		<?php
			...
			if($_POST){
				...
				$sql = "INSERT INTO `media`(`title`, `image`, `ISBN`, `description`, `publish_date`, `publisher_name`, `publisher_address`, `publisher_size`, `media_type`, `availability`, `author_fname`, `author_lname`) VALUES ('$title', '$image', '$isbn', '$description', '$pDate', '$pName', '$pAddress', '$pSize', '$mType', '$availability', '$aFName', '$aLName')";

				if(mysqli_query($conn, $sql)){
					echo "<div class=\"alert alert-success text-center\" role=\"alert\">
							  <h4 class=\"alert-heading\">Well done!</h4>
							  <p>You successfully added a new item to our catalogue. You can check it out by clicking on the link below.</p>
							  <hr>
